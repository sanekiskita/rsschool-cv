1.Шевелев Александр
2.Почта:as1405503@gmail.com telegram: @sanek_nyst
3.Цель: усовершенствовать свои навыки и найти работу.
4.Знаю языки программирования c++, c#, javascript, SQL, HTML, PHP. Изучал методологию agile. 
5.Отрывок программы:
...
6.Есть опыт работы в создании сайта с подключением базы данных без использования CMS.
7.Среднее профессиональное образование по специальности. 09.02.03
8.Уровень знания английского:Intermediate.